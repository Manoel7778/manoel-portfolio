  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] ${activeLocale === 'pt'?'sm:w-[35rem]':'sm:w-[30rem]'} sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75`}
